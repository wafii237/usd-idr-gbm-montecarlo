...
df_global <- local({
  f <- "data/Data Historis USD_IDR.csv"
...
server <- function(input, output, session) {
  ...
  # ── FIX UNTUK CUSTOM CSS TABS ──
  outputOptions(output, "plot_hist", suspendWhenHidden = FALSE)
  outputOptions(output, "plot_qq", suspendWhenHidden = FALSE)
} # <- Ini adalah kurung tutup fungsi server
